...
# Create a function to extract year and month from the date column and create two new columns
...
def pre_pipeline_preparation(*, data_frame: pd.DataFrame) -> pd.DataFrame:
    ...
    data_frame = get_year_and_month(data_frame) # add 2 new fields yr and mnth to the data_frame by fetching values from dteday field
